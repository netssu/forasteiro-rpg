execute if score @s manhunt_action matches 1 run team leave @s
execute if score @s manhunt_action matches 1 run team join runners @s
execute if score @s manhunt_action matches 1 if entity @s[team=runners] run tellraw @s {"text":"Agora voce esta no time runners.","color":"red"}

execute if score @s manhunt_action matches 2 run team leave @s
execute if score @s manhunt_action matches 2 run team join hunters @s
execute if score @s manhunt_action matches 2 if entity @s[team=hunters] run tellraw @s {"text":"Agora voce esta no time hunters.","color":"blue"}
...
execute if score @s manhunt_action matches 10..13 run tellraw @a [{"text":"Modo de inicio: ","color":"yellow"},{"score":{"name":"Temp","objective":"manhunt_start_mode"},"color":"aqua"}]
...
execute if score @s manhunt_action matches 30..31 run tellraw @a [{"text":"Distancia inicial: ","color":"yellow"},{"score":{"name":"Temp","objective":"manhunt_start_dist"},"color":"gold"}]
...
execute if score @s manhunt_action matches 40..41 run tellraw @a [{"text":"Delay da bussola: ","color":"yellow"},{"score":{"name":"Temp","objective":"manhunt_compass_delay"},"color":"gold"},{"text":"s","color":"gold"}]
