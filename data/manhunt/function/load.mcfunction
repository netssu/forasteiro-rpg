...
scoreboard objectives add manhunt_runner_respawn dummy
scoreboard objectives add manhunt_runner_glow dummy
scoreboard objectives add manhunt_hunter_protect dummy
