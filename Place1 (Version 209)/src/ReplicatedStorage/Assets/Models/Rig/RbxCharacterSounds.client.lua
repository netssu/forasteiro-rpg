...
====================================
        Realistic Footsteps
          Created by Ruben Roy
                  (DarkTwentyFive)
====================================

RbxCharacterSounds - DO NOT MODIFY THIS SCRIPT UNLESS YOU KNOW WHAT YOU'RE DOING
...
local function initializeSoundSystem(player, humanoid, rootPart)
	...
	local loopedSoundUpdaters = {
		...
		[sounds.Running] = function(dt, sound, vel)
			...
			sound.EmitterSize = FootstepsSoundGroup:WaitForChild(humanoid.FloorMaterial.Name).Volume * (vel.Magnitude/12) * 50 * 1
...
Humanoid.Running:connect(function(a)
	RunningSound.PlaybackSpeed 	= FootstepsSoundGroup:WaitForChild(Humanoid.FloorMaterial.Name).PlaybackSpeed * (a/20) * (math.random(30,50)/40)
